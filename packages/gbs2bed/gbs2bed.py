...
def readData(gbsfile="/home/jolyang/dbcenter/seeds_data/All_SeeD_2.7_chr10_no_filter.unimputed.hmp.txt"):
  ### read.table
  gbs = pd.read_table(gbsfile, sep="\t", header= True)
...
def version():
    ...
    purpose: convert GBS to bed+ format!
    --------------------------------

    updated: not initialled yet!
    ##########################################################################################
    """
    return ver0
